	...
	<div class="rdsubs rdsubs-myinvoices">
		...
		<table class="table table-striped">
			...
			<thead>
				...
				<th width="13%">
					<div class="text-center"><?php echo JText::_('COM_RDSUBS_INVOICE_DATE'); ?></div>
				</th>
				<th width="13%">
					<div class="text-center"><?php echo JText::_('COM_RDSUBS_ORDER_ID'); ?></div>
				</th>
				<th width="15%">
					<div class="text-center"><?php echo JText::_('COM_RDSUBS_PAYMENT_AMOUNT'); ?></div>
				</th>
				<th width="19%">
					<div class="text-center"><?php echo JText::_('COM_RDSUBS_PAYMENT_STATE'); ?></div>
				</th>
				<th width="15%">
			...
			for ($i = 0, $n = count($this->items); $i < $n; $i++)
			{
				...
				<tr>
					<td>
						<div class="text-center"><?php echo ! empty($row->invoice_no) ? $row->invoice_no : $row->id; ?></div>
					</td>
					<td>
						<div class="text-center"><?php echo Date::_($row->invoicedate); ?></div>
					</td>
					<td>
						<div class="text-center"><?php echo $row->ordercode; ?></div>
					</td>
					<td>
						<div class="text-center"><?php echo RDSubsPrice::_($row->net_price); ?></div>
					</td>
					<td>
						<div class="text-center"><?php echo RDSubsHelper::getPaymentState($row->paid); ?></div>
					</td>
					<td><a href="<?php echo $download; ?>" class="btn btn-mini btn-outline-success"><?php echo JText::_('COM_RDSUBS_DOWNLOAD'); ?></a></td>
				</tr>
