...
<?php if ($amount->netprice() > 0) : ?>
	...
	<button name="makePayment" id="makePayment" class="btn btn-lg btn-outline-success"
...
<?php else: ?>
	...
	<button name="makePayment" id="makePayment" class="btn btn-outline-success btn-lg"
	        onclick="submitCheckoutForm();">
...
<a href="<?php echo JRoute::_('index.php?option=com_rdsubs&view=products'); ?>" class="btn btn-outline-secondary pull-right">
