...
<div class="rdsubs rdsubs-product">
	...
	<div class="row">
		<div class="col col-12 col-md-4">
				<img src="<?php echo RDSubsImage::getUrl($this->item->id); ?>" class="img-fluid img-thumbnail rounded mx-auto d-block">
	...
	<div class="buttons_main">
		<?php if ($this->item->price > 0) : ?>
			<a href="<?php echo $link; ?>" class="btn btn-outline-success btn-lg">
	...
	<div class="btn-group">
		...
		<?php if ($this->item->link_demo): ?>
			<a href="<?php echo $this->item->link_demo; ?>" target="_blank" class="btn btn-outline-secondary">
				<?php echo JText::_('COM_RDSUBS_DEMO_BUTTON'); ?></a>
		<?php endif; ?>

		<?php if ($this->item->link_to_review) : ?>
			<a href="<?php echo $this->item->link_to_review; ?>" target="_blank" class="btn btn-outline-secondary">
				<?php echo JText::_('COM_RDSUBS_REVIEW_COMPONENT'); ?></a>
		<?php endif; ?>

		<?php if ($this->item->link_to_support): ?>
			<a href="<?php echo $this->item->link_to_support; ?>" target="_self" class="btn btn-outline-secondary"><?php echo JText::_('COM_RDSUBS_PRESALE_QUESTION'); ?></a>
		<?php endif; ?>
